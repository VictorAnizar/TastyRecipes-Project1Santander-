    ...
    btn_buscar.addEventListener("click", function () {
        if (search_input.value != "") {
            ...
            setTimeout(() => {
                ...
                document.querySelector("#div_recipe_random").style.display =
                    "none";
            }, 300);
                ...
                .then((data) => {
                    ...
                    for (let index = 0; index < data.meals.length; index++) {
                        ...
                        div_card.addEventListener("click", function () {
                            ...
                            document
                                .querySelector("#section_titulo")
                                .appendChild(card_modal);
                            ...
                            document.querySelector(
                                ".modal-content"
                            ).innerHTML = `<div id="image-title-modal">
                                    <img src="${
                            ...
                            document.querySelector(
                                ".modal-content"
                            ).style.animationName = "modal-open";
                        });
    ...
    div_card.addEventListener("click", function () {
        ...
        for (let index = 1; index <= 20; index++) {
            if (
                ...
                data.meals[0]["strIngredient" + index] == null
            ) {
                continue;
            } else {
                arrIngredientes.push(
